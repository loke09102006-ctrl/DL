...
model_path = r"E:\DL project\UAVid_Dehazing\models\dwt_cnn\dwt_cnn_dehazer.pth"
...
print("DWT + CNN model loaded successfully.")
...
def dehaze_large_image(image, tile_size=256):
    ...
    for y in range(0, original_height, tile_size):
        for x in range(0, original_width, tile_size):
            ...
            # Put tile back into its original position
...
if count > 0:
    print("\n--------------------------------")
    print("DWT + CNN Evaluation Complete")
    print("--------------------------------")
